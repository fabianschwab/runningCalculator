...
<div class="prose m-auto max-w-4xl px-3 pb-16 pt-6">
	...
	<div class="btm-nav">
		<button onclick={() => goto('/')} class={$page.url.pathname === '/' ? 'active' : ''}>
			<svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
				...
				/></svg
			>
			<span class="btm-nav-label text-xs">Distance</span>
		</button>
		<button onclick={() => goto('/pace')} class={$page.url.pathname === '/pace' ? 'active' : ''}>
			<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24"
				><path
					fill="currentColor"
					d="M14.96 5.096q-.331 0-.559-.229t-.228-.56t.229-.56t.56-.228t.56.23t.228.56t-.229.56t-.56.227m-.058 15.385q-.332 0-.56-.23q-.228-.228-.228-.56q0-.331.23-.56q.228-.227.56-.227t.56.229t.227.56t-.229.56t-.56.228m4-12.116q-.332 0-.56-.229q-.227-.229-.227-.56t.228-.56t.561-.228t.56.23q.227.228.227.56t-.229.56t-.56.227m-.058 8.904q-.331 0-.56-.229q-.227-.229-.227-.56t.229-.56t.56-.228t.56.23t.228.56t-.23.56q-.228.227-.56.227m1.366-4.48q-.332 0-.56-.23q-.228-.228-.228-.56t.229-.56t.56-.227t.56.229t.228.56t-.229.56t-.56.227M3 11.997q0-3.595 2.449-6.18t5.999-2.806q.227-.011.39.134q.162.146.162.36q0 .203-.157.349t-.364.157q-3.16.197-5.32 2.495Q4 8.804 4 12q0 3.221 2.16 5.507t5.319 2.481q.208.012.364.162t.157.35q0 .214-.162.357t-.39.132q-3.556-.222-6.002-2.81T3 11.998m9 1.503q-.633 0-1.066-.434T10.5 12q0-.183.032-.34t.12-.3L9.046 9.735q-.14-.14-.13-.344q.009-.204.15-.345t.334-.14t.335.14l1.625 1.606q.119-.063.64-.152q.633 0 1.066.434q.434.433.434 1.066t-.434 1.066T12 13.5"
				/></svg
			>
			<span class="btm-nav-label text-xs">Pace</span>
		</button>
	</div>
</div>
